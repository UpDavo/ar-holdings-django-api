    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Total', models.IntegerField()),
                ('IdEncabezado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='detalle', to='ArHoldingsApp.facturacionencabezado')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IdEncabezado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cliente', to='ArHoldingsApp.facturacionencabezado')),
            ],
        ),
        migrations.CreateModel(
